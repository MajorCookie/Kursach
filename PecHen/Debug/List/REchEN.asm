...
; 0000 0022 		4: deviation indicator
; 0000 0023 	*/
; 0000 0024 	int MODE = 0;
; 0000 0025 
; 0000 0026 	PORTD=0b00000001;
;	MODE -> R16,R17
	__GETWRN 16,17,0
	LDI  R30,LOW(1)
	OUT  0x12,R30
; 0000 0027 	DDRD=0b00000000;
	LDI  R30,LOW(0)
	OUT  0x11,R30
; 0000 0028 
...
; 0000 002A 	DDRC=0x00;
	OUT  0x14,R30
; 0000 002B 
; 0000 002C 	PORTB=0b00000000;
	OUT  0x18,R30
; 0000 002D 	DDRB=0b00111111;
	LDI  R30,LOW(63)
	OUT  0x17,R30
; 0000 002E 
; 0000 002F 
...
; 0000 005E 
; 0000 005F 				// turning off 1st indicator, turning on 2nd indicator
; 0000 0060 				PORTB.0 = 0;
; 0000 0061 				PORTB.1 = 1;
	RCALL SUBOPT_0x3
; 0000 0062 				delay_ms(100);
; 0000 0063 
; 0000 0064 				// turning off 2nd indicator, turning on 3rd indicator
; 0000 0065 				PORTB.1 = 0;
; 0000 0066 				PORTB.2 = 1;
	RCALL SUBOPT_0x4
...
; 0000 0075 
; 0000 0076 				// turning off last indicator
; 0000 0077 				PORTB.5 = 0;
...
; 0000 0094 
; 0000 0095 				// turning off first indicator
; 0000 0096 				PORTB.0 = 0;
